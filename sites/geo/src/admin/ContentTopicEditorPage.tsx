      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "32px 24px" }}>
        ...
        {topicId && (
          <div style={{ marginBottom: 12, display: "flex", gap: 8, flexWrap: "wrap" }}>
            <a href={`/admin/content-drafts/new?topicId=${topicId}&leadId=${leadId || ""}&brandAssetId=${brandAssetId || ""}`} style={{ fontSize: 12, fontWeight: 600, color: "#7c3aed", textDecoration: "none", padding: "4px 10px", background: "#ede9fe", borderRadius: 4 }}>+ 新建稿件</a>
            <a href={`/admin/content-drafts?topicId=${topicId}`} style={{ fontSize: 12, fontWeight: 600, color: "#5a6a7e", textDecoration: "none", padding: "4px 10px", background: "#f0f2f5", borderRadius: 4 }}>查看关联稿件</a>
            {leadId && (
