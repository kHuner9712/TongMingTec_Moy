...
import { CustomerRuntimeQueryDto, AgentRunQueryDto } from './dto/customer-runtime-query.dto';
...
export class AiRuntimeController {
  ...
  async getCustomerTimeline(
    ...
    const data = await this.aiRuntimeService.getCustomerTimeline(id, orgId, query);
    return { code: 'OK', data };
  }
  ...
  async rejectRequest(
    ...
    const data = await this.aiRuntimeService.rejectRequest(id, orgId, userId, dto.reason);
    return { code: 'OK', data };
  }
