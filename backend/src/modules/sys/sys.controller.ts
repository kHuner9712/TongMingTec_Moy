...
import { IsString, IsObject, IsArray, IsInt, Min } from 'class-validator';
...
export class SystemConfigController {
  ...
  async getConfig(
    ...
    return this.sysService.getConfig(orgId, id);
  }
  ...
  async updateConfig(
    ...
    return this.sysService.setConfig(orgId, id, dto.value);
  }
