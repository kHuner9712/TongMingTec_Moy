...
@Module({
  imports: [
    TypeOrmModule.forFeature([CustomerTimelineEvent, CustomerOperatingRecord, CustomerStateSnapshot]),
    CmModule,
    LmModule,
    OmModule,
    CnvModule,
  ...
  providers: [TimelineService, Customer360Service, OperatingRecordService, SnapshotService],
  exports: [TimelineService, Customer360Service, OperatingRecordService, SnapshotService],
})
