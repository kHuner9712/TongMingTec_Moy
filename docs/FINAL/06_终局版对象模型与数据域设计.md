...
| 输入来源 | [02_业务域地图](./02_终局版业务域地图与能力版图.md)、[04_端到端业务链路](./04_终局版端到端业务链路蓝图.md)、[05_系统信息架构](./05_终局版系统信息架构与模块树.md)、[P0_DBD](../P0/10_DBD_数据模型与数据字典.md) |
...
| [P0_10_DBD_数据模型与数据字典](../P0/10_DBD_数据模型与数据字典.md)  | v3.1 | P0 数据模型参考  |
