...
- 本文与 `08A/08B` 的互链统一使用仓库内相对路径，禁止再出现任何本地绝对路径。
...
| API-AUTO-007~011 | `GET /automation/triggers` `POST /automation/triggers` `GET /automation/triggers/{id}` `PUT /automation/triggers/{id}` `DELETE /automation/triggers/{id}` | S2 | `SCH-PATH-ID / SCH-AUTO-TRIGGER-* / SCH-AUTO-TRIGGER-* / SCH-HEADER-AUTH` | `SCH-AUTO-TRIGGER-LIST` / `SCH-AUTO-TRIGGER-DETAIL` | `200/201/400/403/409` | `PERM-AUTO-MANAGE` | ORG | 是 | 创建是 | `version` | `AUTOMATION_TRIGGER_*` | `EX-AUTO-002` |
...
| API-SUB-001~002 | `GET/POST /subscriptions` | S2 | `SCH-PATH-ID / SCH-SUB-* / SCH-SUB-* / SCH-HEADER-AUTH` | `SCH-SUB-*` | `200/201/400/403/409` | `PERM-SUB-*` | ORG | 是 | 创建是 | `version` | `SUBSCRIPTION_CREATE` | `EX-SUB-001` |
| API-SUB-003~004 | `GET/PUT /subscriptions/{id}` `POST /subscriptions/{id}/renew` `POST /subscriptions/{id}/suspend` | S3 | `SCH-PATH-ID / SCH-SUB-* / SCH-SUB-* / SCH-HEADER-AUTH` | `SCH-SUB-*` | `200/201/400/403/409` | `PERM-SUB-*` | ORG | 是 | 续费/暂停是 | `version` | `SUBSCRIPTION_UPDATE/RENEW/SUSPEND` | `EX-SUB-001` |
...
| API-PAY-001 | `POST /payments` | S2 | `SCH-PATH-ID / SCH-PAY-* / SCH-PAY-* / SCH-HEADER-AUTH` | `SCH-PAY-*` | `200/201/400/403/409` | `PERM-PAY-*` | ORG | 是 | 创建是 | `version` | `PAYMENT_CREATE` | `EX-PAY-001` |
| API-PAY-002 | `POST /payments/{id}/reconcile` | S3 | `SCH-PATH-ID / SCH-PAY-* / SCH-PAY-* / SCH-HEADER-AUTH` | `SCH-PAY-*` | `200/201/400/403/409` | `PERM-PAY-*` | ORG | 是 | 对账是 | `version` | `PAYMENT_RECONCILE` | `EX-PAY-001` |
