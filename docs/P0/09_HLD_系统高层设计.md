...
| [06*PRD*产品需求规格说明书\_v0.1.md](./06_PRD_产品需求规格说明书_v0.1.md) | v0.1 | 产品需求规格     |
| [07*RTM*需求跟踪矩阵.md](./07_RTM_需求跟踪矩阵.md)                        | v0.1 | 需求跟踪矩阵     |
...
|              | REQ-TM-008  | P0     | 工单关闭     |
|              | REQ-TM-009  | P0     | 工单统计     |
| **知识库**   | REQ-KB-001  | P1     | 知识检索     |
|              | REQ-KB-002  | P1     | 知识详情     |
|              | REQ-KB-003  | P1     | AI 问答      |
|              | REQ-KB-004  | P1     | 知识分类     |
|              | REQ-KB-005  | P1     | 知识管理     |
|              | REQ-KB-006  | P1     | 知识审核     |
| **数据看板** | REQ-DB-001  | P1     | 销售看板     |
|              | REQ-DB-002  | P1     | 客服看板     |
|              | REQ-DB-003  | P1     | 全览看板     |
|              | REQ-DB-004  | P1     | 趋势图表     |
...
| 技术选型 | 最终方案      | 状态      | 决策文档                                 |
| -------- | ------------- | --------- | ---------------------------------------- |
| LLM 服务 | DeepSeek      | ✅ 已冻结 | [36\_技术选型冻结](./36_技术选型冻结.md) |
| 云服务商 | 阿里云        | ✅ 已冻结 | [36\_技术选型冻结](./36_技术选型冻结.md) |
| 消息队列 | Redis Streams | ✅ 已冻结 | [36\_技术选型冻结](./36_技术选型冻结.md) |
| 日志服务 | 阿里云 SLS    | ✅ 已冻结 | [36\_技术选型冻结](./36_技术选型冻结.md) |
| 文件存储 | 阿里云 OSS    | ✅ 已冻结 | [36\_技术选型冻结](./36_技术选型冻结.md) |
| 监控方案 | Prometheus    | ✅ 已冻结 | [36\_技术选型冻结](./36_技术选型冻结.md) |
| API 网关 | Kong          | ✅ 已冻结 | [36\_技术选型冻结](./36_技术选型冻结.md) |
...
| 编号        | 事项                       | 状态      | 决策结果      | 决策文档                                 |
| ----------- | -------------------------- | --------- | ------------- | ---------------------------------------- |
| TBD-HLD-001 | LLM 服务商最终选择         | ✅ 已解决 | DeepSeek      | [36\_技术选型冻结](./36_技术选型冻结.md) |
| TBD-HLD-002 | 云服务商最终选择           | ✅ 已解决 | 阿里云        | [36\_技术选型冻结](./36_技术选型冻结.md) |
| TBD-HLD-003 | 消息队列技术选型           | ✅ 已解决 | Redis Streams | [36\_技术选型冻结](./36_技术选型冻结.md) |
| TBD-HLD-004 | 日志服务技术选型           | ✅ 已解决 | 阿里云 SLS    | [36\_技术选型冻结](./36_技术选型冻结.md) |
| TBD-HLD-005 | 数据库读写分离是否首期实现 | ✅ 已解决 | 首期不实现    | [36\_技术选型冻结](./36_技术选型冻结.md) |
| TBD-HLD-006 | Elasticsearch 是否首期部署 | ✅ 已解决 | 首期实现      | [36\_技术选型冻结](./36_技术选型冻结.md) |

**说明：** 以上待确认事项已通过技术选型冻结文档处理完成，不再有 [TBD] 未决项。
...
| v1.0     | 2026-04-05 | MOY 文档架构组 | 一致性治理：统一知识库/数据看板需求优先级为P1，与RTM保持一致 | 已确认 |
| v1.1     | 2026-04-05 | MOY 文档架构组 | 技术选型冻结：消除所有TBD待确认项，详见36\_技术选型冻结.md   | 已确认 |
